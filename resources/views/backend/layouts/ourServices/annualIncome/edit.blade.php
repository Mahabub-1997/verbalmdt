    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid d-flex justify-content-between align-items-center mb-3">
                <h1 class="m-0">Edit Annual Income</h1>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-teal text-white">
                        <h5 class="mb-0">Update Annual Income Information</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('annual-incomes.update', $annualIncome->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="annual_income" id="annual_income"
                                       ...
                                       value="{{ old('annual_income', $annualIncome->annual_income) }}" required>
